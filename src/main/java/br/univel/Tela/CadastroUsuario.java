...
public class CadastroUsuario extends JFrame {
	...
	public CadastroUsuario() {
		...
		gbl_panel.columnWidths = new int[]{46, 242, 91, 0};
		gbl_panel.rowHeights = new int[]{22, 22, 22, 22, 22, 0, 64, 23, 0};
		...
		gbc_btnDeletar.anchor = GridBagConstraints.NORTHEAST;
		gbc_btnDeletar.insets = new Insets(0, 0, 0, 5);
		gbc_btnDeletar.gridx = 1;
		gbc_btnDeletar.gridy = 7;
